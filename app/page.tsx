  ...
  useEffect(() => {
    const initSDK = async () => {
      try {
        ...
        console.log('⚠️ SDK error (OK in browser):', e);
      }
      fetchStats();
    };
    initSDK();
    ...
    <div className="min-h-screen bg-[#000814] pb-20">
      ...
      <div className="relative z-10 p-6 fade-in-up">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-[#0A0E14]/60 backdrop-blur-md border-2 border-blue-500/30 rounded-2xl p-6">
            ...
            <div className="text-4xl font-black text-blue-500 mb-2">{loading ? '-' : stats.locked}</div>
          ...
          <div className="bg-[#0A0E14]/60 backdrop-blur-md border-2 border-green-500/30 rounded-2xl p-6">
            ...
            <div className="text-4xl font-black text-green-500 mb-2">{loading ? '-' : stats.revealed}</div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <a href="/create" className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl p-6 shadow-xl">
            ...
            <a href="/capsules" className="bg-[#0A0E14]/60 border-2 border-[#0052FF]/30 rounded-2xl p-6">
              <Sparkles className="w-8 h-8 text-[#0052FF] mb-3" />
              <p className="text-white font-black text-lg">View Capsules</p>
              <p className="text-gray-400 text-sm mt-1">See collection</p>
            </a>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#0A0E14]/60 border-2 border-[#0052FF]/20 rounded-2xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Write messages, predictions, goals. Lock them on-chain.</p>
              </div>
            </div>
          </div>
          <div className="bg-[#0A0E14]/60 border-2 border-cyan-500/20 rounded-2xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">1 hour to 1 year. Time-locked on Base.</p>
              </div>
            </div>
          </div>
          <div className="bg-[#0A0E14]/60 border-2 border-green-500/20 rounded-2xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Get NFT proof. Forever on Base blockchain.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 h-16 bg-[#0A0E14]/95 backdrop-blur-md border-t-2 border-[#0052FF]/20 z-50">
        <div className="h-full flex items-center justify-around px-6">
          <a href="/" className="flex flex-col items-center gap-1 text-[#0052FF]">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
            <span className="text-xs font-bold">Home</span>
          </a>
          <a href="/capsules" className="flex flex-col items-center gap-1 text-gray-400 hover:text-white">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
            <span className="text-xs font-bold">Capsules</span>
          </a>
          <a href="/create" className="flex flex-col items-center gap-1 text-gray-400 hover:text-white">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
            <span className="text-xs font-bold">Create</span>
          </a>
          <a href="/reveals" className="flex flex-col items-center gap-1 text-gray-400 hover:text-white">
          ...
          <a href="/profile" className="flex flex-col items-center gap-1 text-gray-400 hover:text-white">
