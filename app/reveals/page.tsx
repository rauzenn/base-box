...
import { Unlock, Calendar, Sparkles, ArrowRight } from 'lucide-react';
...
export default function RevealsPage() {
  // Hardcoded FID for testing (will be replaced with Farcaster SDK)
  const fid = 3;
      ...
      <div className="relative z-10">
        ...
        <div className="p-6 pb-8">
          <div className="flex items-center gap-4 mb-2">
            <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center shadow-xl shadow-green-500/30">
        ...
        <div className="px-6">
          {loading ? (
            ...
            <div className="text-center py-20">
              <div className="w-24 h-24 bg-[#0A0E14]/60 backdrop-blur-md border-2 border-green-500/30 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-xl shadow-green-500/20">
              ...
              <a
                href="/create"
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl font-bold text-white shadow-xl shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300"
              >
            ...
            <div className="space-y-4 pb-6">
              {revealedCapsules.map((capsule) => (
                <div
                  key={capsule.id}
                  className="bg-[#0A0E14]/60 backdrop-blur-md border-2 border-green-500/30 rounded-2xl p-6 shadow-xl hover:border-green-500/50 hover:shadow-green-500/20 transition-all duration-300"
                >
